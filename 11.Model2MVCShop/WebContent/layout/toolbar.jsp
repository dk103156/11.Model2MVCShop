...
<div class="navbar  navbar-inverse navbar-fixed-top">
	...
	<div class="container">
       	...
       	<a class="navbar-brand" href="/index.jsp" style="padding: 0px;">
       		<img alt="" src="../images/uploadFiles/Disney-store.jpg" style="width: 120px; height: 100px; padding-bottom: 40px; border-bottom-width: 0px;">
       	</a>
   	...
   	<script type="text/javascript">
		...
		//=============  개인정보조회 Event  처리 =============	
	 	...
	 	//=============  판매상품관리 Event  처리 =============	
	 	$( "li > ul a:contains('판매상품관리')" ).on("click" , function() {
	 		//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
