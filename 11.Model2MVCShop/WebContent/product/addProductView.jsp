...
<!-- 	<script type="text/javascript" src="../javascript/calendar.js"></script>	 -->
	...
	// 달력 이벤트
/* 	$(function() {
		 $( ".ct_icon_date" ).on("click" , function(){
...
<body>
	...
	<div class="container">
		...
		<div class="page-header text-center">
	       ...
	       <h5 class="text-muted">상품 등록을 원하시면 <strong class="text-danger">등록</strong> 버튼을 클릭해 주세요.</h5>
	    </div>		
		...
		<form class="form-horizontal" name="detailForm">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <textarea  class="form-control" id="prodDetail" name="prodDetail" placeholder="상품상세정보..." 
		      style="width: 358px; height: 200px; padding: 10px;"></textarea>
		    </div>
		  </div>		
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-2">
		      <input type="text" class="form-control" id="datepicker" name="manuDate" placeholder="제조일자" readonly>
		    </div> 
		  </div>		
			...
			<div class="col-sm-3">					   
				<div class="input-group">
					<span class="input-group-addon">￦</span>
						<input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="price" placeholder="가격"
